...
class NetworkInterface {
  private:
    ...
    struct Datagram_nexthop {
        Address next_hop;
        InternetDatagram datagram;
    };

    std::map<uint32_t, ARP_Entry> _arp_map {};
    //store IPDatagrams waiting for ARP response
    std::vector<Datagram_nexthop> _waiting_arp_IPV4Datagram {};
    //store arp response which has been sent
    std::map<uint32_t, size_t> _waiting_arp_response_IP_map {};
  public:
